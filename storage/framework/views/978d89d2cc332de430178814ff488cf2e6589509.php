                        ...
                        <tbody>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="<?php echo e(route('category.edit', $item->id)); ?>" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $('.delete').on('click', function () {
            const id = this.id;
            $('#deleteModal').attr('action', "<?php echo e(route('category.destroy', '')); ?>" + '/' + id);
        });
    </script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\library\resources\views/category/index.blade.php ENDPATH**/ ?>