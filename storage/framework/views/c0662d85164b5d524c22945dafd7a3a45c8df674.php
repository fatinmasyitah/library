                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($index + $books->firstItem()); ?></td>
                                    <td>
                                        <img src="<?php echo e(asset($item->bookimage)); ?>" class="avatar-book" alt="<?php echo e($item->bookname); ?>" width="60">
                                    </td>
                                    <td><?php echo e($item->booktitle); ?></td>
                                    <td><?php echo e($item->category->categoryname); ?></td>
                                    <td><?php echo e($item->author->authorname); ?></td>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="<?php echo e(route('book.edit', $item->id)); ?>" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $('.delete').on('click', function () {
            const id = this.id;
            $('#deleteModal').attr('action', "<?php echo e(route('book.destroy', '')); ?>" + '/' + id);
        });
    </script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\library\resources\views/book/index.blade.php ENDPATH**/ ?>